...
public class SonarEntriesProcessor {
	...
	public String sendGetRequest(String component, int page, int pageSize) throws Exception {

		String url =SONAR_BASE_URL +component+"&p="+page+"&ps="+pageSize+"&qualifiers=FIL";
	...
	public MainPageEntry getMainEntry(String project) throws Exception{
		...
		while (hasMore){
			...
			getResponse = sendGetRequest(project,pageNum, pageElements);
